(function() {
  ...
  Client = (function() {
    function Client(io_or_socket, options) {
      ...
      this.join(this.sub_name_space);
    }

    Client.prototype.join = function(sub_name_space) {
      if (!(__indexOf.call(this._joined, sub_name_space) >= 0)) {
        this._socket.emit('join', {
          sub_name_space: sub_name_space
        });
        return this._joined.push(sub_name_space);
      }
    };
