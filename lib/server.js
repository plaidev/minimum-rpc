    ...
    Server.prototype.join = function(socket, sub_name_space) {
      ...
      return socket.on(sub_name_space + '_apply', (function(_this) {
        return function(req, ack_cb) {
          ...
          method = req.method;
          args = req.args || [];
          method = ((_ref = _this.methods[sub_name_space]) != null ? _ref[method] : void 0) || ((_ref1 = _this.methods[DEFAULT_SUB_NAME_SPACE]) != null ? _ref1[method] : void 0);
          if ((method != null ? method.apply : void 0) == null) {
            return ack_cb({
          ...
          args.push(socket);
          try {
            return method.apply(_this.methods[sub_name_space] || _this.methods[DEFAULT_SUB_NAME_SPACE], args);
          } catch (_error) {
            e = _error;
